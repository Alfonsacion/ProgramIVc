...
int mainAdmin(void)
{
	...
	while (opcion <= 6 && opcion >= 0)
	{
		...
		cout << "1. Visualizar tus datos" << endl
			 << endl;
		...
		case 1:
			cout << endl
				 << endl
				 << "///////////Visualizacion de datos personales///////////" << endl
				 << endl;
		...
		case 2:
			cout << endl
				 << endl
				 << "///////////Indique los datos del cliente que quiere anyadir///////////" << endl
				 << endl;
			...
			char *correo;
			char *tlf;
			cout << "Dime el nombre de usuario que quieres anyadir: " << endl;
			cin >> nomUsuario;
			cout << "Dime la contrasenya del usuario que quieres anyadir: " << endl;
			cin >> contrasenya;
			cout << "Dime el dni del usuario que quieres anyadir: " << endl;
			cin >> dni;
			cout << "Dime el correo del usuario que quieres anyadir: " << endl;
			cin >> correo;
			cout << "Dime el tlfn del usuario que quieres anyadir: " << endl;
			cin >> tlf;
		...
		case 3:
			...
			cout << endl
				 << endl
				 << "///////////¿Que cliente desea eliminar?///////////" << endl
				 << endl;
			cout << "Dime el nombre del usuario que quieres eliminar: " << endl;
			cin >> nomUsuario;
		...
		case 4:
			cout << endl
				 << endl
				 << "///////////Has cerrado sesion, hasta pronto!///////////" << endl
				 << endl;
			opcion = 6;
			break;
		...
		default:
			cout << endl
				 << endl
				 << "///////////La opcion seleccionada no es valida///////////" << endl
				 << endl;
			fflush(stdin);
			break;
		}
